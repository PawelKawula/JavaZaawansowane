...
public class TransformTest
{
    ...
    public static void main(String[] args) throws IOException, TransformerException
    {
        ...
        else path = Paths.get("src", "transform", "makehtml.xsl");
        try (InputStream styleIn = Files.newInputStream(path))
        {
            ...
            try (InputStream docIn =
                    Files.newInputStream(Paths.get("src", "transform", "employee.dat")))
            {
                t.transform(new SAXSource(new EmployeeReader(),
                        new InputSource(docIn)), new StreamResult(System.out));
            }
        }
    }
}
